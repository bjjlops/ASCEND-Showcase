...
A dark, premium foundation with gold reserved for moments that matter.

| Role | Color | Use |
| --- | --- | --- |
| **Black** | `#0A0A0B` | Primary background; the premium foundation |
| **Deep charcoal** | `#16161A` | Panels, navigation, secondary surfaces |
| **Gold** | `#E3B341` | Progress, focus, achievement — the primary accent |
| **Warm white** | `#F5F2EA` | Primary text on dark surfaces |
| **Muted gray** | `#8A8A93` | Secondary text, separators, inactive states |

**Rules**

- Gold is an **accent for precision and focus**, not a full-page wash. Used sparingly, it means
  something.
- **Risk states get clear, semantic colors and labels** — especially in Trader. Risk is never
  communicated by gold alone.
- Contrast stays high enough for mobile, desktop, and dense command-center views alike.

## Typography

- **Strong headings** for command and orientation.
